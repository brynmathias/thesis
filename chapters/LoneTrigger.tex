...
\section{Effect on trigger rates} % (fold)
...
\subsection{Summary of the effects on trigger rates} % (fold)
...
% Section~\ref{sub:High Pile Up} shows that we cut the rate of the L1$\_$HTT triggers by upto 99$\%$ in high pile up conditions,



% subsection Summary of the effects on trigger rates (end)

% section Effects on Rate (end)
\section{Effect on trigger efficiency} % (fold)
...
\subsection{Summary of effects on efficiency} % (fold)
...
% subsection Summary of effects on efficiency (end)
